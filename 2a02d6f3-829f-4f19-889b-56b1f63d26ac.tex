...
\subsection*{2.1. Design of the IHTC test facility}
...
\begin{figure}[h]
\begin{center}
  \includegraphics[alt={},max width=\textwidth]{2a02d6f3-829f-4f19-889b-56b1f63d26ac-2_865_868_208_129}
\captionsetup{labelformat=empty}
\caption{Fig. 1. Overall schematic structure of the IHTC test facility.}
\end{center}
\end{figure}
...
\subsection*{2.2. Experimental procedures}
...
\begin{figure}[h]
\begin{center}
  \includegraphics[alt={},max width=\textwidth]{2a02d6f3-829f-4f19-889b-56b1f63d26ac-2_858_828_206_1095}
\captionsetup{labelformat=empty}
\caption{Fig. 2. The FE model of the IHTC test facility in PAM-STAMP.}
\end{center}
\end{figure}
...
\subsection*{2.3. FE simulation procedures}
...
\hline
Property & \multicolumn{3}{|c|}{AA7075} \\
\hline
Young's modulus (MPa) & \multicolumn{3}{|c|}{$-39.082 \mathrm{~T}+82532$} \\
\hline
Density ( $\mathrm{kg} / \mathrm{m}^{3}$ ) & \multicolumn{3}{|c|}{$-6.7537 \mathrm{e}-05 \mathrm{~T}^{2}-0.15 \mathrm{~T}+2.8608 \mathrm{e} 03$} \\
\hline
Thermal conductivity ( $\mathrm{kW} / \mathrm{mK}$ ) & \multicolumn{3}{|c|}{$-5.145 \mathrm{e}-08 \mathrm{~T}^{2}+1.368 \mathrm{e}-04 \mathrm{~T}$ + 0.085224} \\
\hline
Specific heat capacity (J/kgK) &  & $8.721 \mathrm{e}-07 \mathrm{~T}^{3}-1.4625 \mathrm{e}-03 \mathrm{~T}^{2}+1.2 \mathrm{~T}+608.3$ &  \\
\hline
Poisson's ratio (-) & \multicolumn{3}{|c|}{\multirow{2}{*}{$3.893 \mathrm{e}-08 \mathrm{~T}^{2}+0.000013505 \mathrm{~T}$ + 0.325165}} \\
\hline
 &  &  &  \\
\hline
Thermal expansion (-) & \multicolumn{3}{|c|}{$0.0216 \mathrm{~T}+16.499$} \\
\hline
...
\subsection*{3.1. Effect of contact pressure on IHTC}
...
\begin{figure}[h]
\begin{center}
  \includegraphics[alt={},max width=\textwidth]{2a02d6f3-829f-4f19-889b-56b1f63d26ac-3_778_1086_1767_488}
\captionsetup{labelformat=empty}
\caption{Fig. 3. The comparison between experimental and simulated temperature evolutions at a contact pressure of 3 MPa under dry conditions, using cast iron tools.}
\end{center}
\end{figure}

\begin{figure}[h]
\begin{center}
  \includegraphics[alt={},max width=\textwidth]{2a02d6f3-829f-4f19-889b-56b1f63d26ac-4_845_1175_193_447}
\captionsetup{labelformat=empty}
\caption{Fig. 7. The IHTC evolutions with applied lubricant layer thickness using cast iron tools, at contact pressures of 5 and 10 MPa .}
\end{center}
\end{figure}
...
\section*{4. Development of a mechanism based IHTC model}
...
\begin{figure}[h]
\begin{center}
  \includegraphics[alt={},max width=\textwidth]{2a02d6f3-829f-4f19-889b-56b1f63d26ac-5_771_1081_1774_493}
\captionsetup{labelformat=empty}
\caption{Fig. 8. The predicted IHTC evolutions with contact pressure using P20 tools under dry and lubricated conditions.}
\end{center}
\end{figure}
