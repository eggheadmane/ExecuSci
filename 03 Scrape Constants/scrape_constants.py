...
DEFAULT_CONSTANTS_PATH = os.path.join(HERE, "constants.py")
DEFAULT_REPORT_PATH = os.path.join(HERE, "constants.md")
...
def generate_report(text: str, source: str = "", include_prose: bool = True) -> str:
...
def run(
    ...
    with open(report_path, "w", encoding="utf-8") as fh:
        fh.write(generate_report(text, source=path, include_prose=include_prose))
