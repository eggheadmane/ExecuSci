...
Usage::
    ...
    python run_pipeline.py --paper "01 PDF2Latex/target_paper.md"
...
from execusci_paths import add_stages, paper_path, stage_dir
...
import main as latex2python_main  # noqa: E402
...
def run(paper: Optional[str] = None, plot: bool = False, quiet: bool = True) -> int:
    ...
    status = latex2python_main.run_document(equations_md, verbose=not quiet)
