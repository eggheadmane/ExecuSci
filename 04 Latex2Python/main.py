...
``latex2python`` and writes ``equations.py`` next to this file.  The symbol
dictionary from stage 02 is used to document each generated function's
arguments in the paper's own words.

Run it with::

    python "04 Latex2Python/main.py"
    python "04 Latex2Python/main.py" --source "01 PDF2Latex/target_paper.md"
"""
...
DEFAULT_MODULE = os.path.join(HERE, "equations.py")
